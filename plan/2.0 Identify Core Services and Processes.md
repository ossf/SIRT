...
* Users
* Public safety organizations, community at large, the world
...
For year one, the SIRT will provide guidance and best practices documentation to maintainers on how to evaluate vulnerability reports in their open source project and react to zero-day exploitation reports.

For year two and later, we will expand and start helping to evaluate and assist maintainers receiving reports of novel vulnerabilities and in-the-wild exploitation of vulnerabilities in their open source project.
...
In SIRT terms, staff can work on relatively lower priority cases or projects but be prepared to 
...
Depends on Services and Engagement sections

### Key Steps/Milestones

Planning committee defines some criteria
